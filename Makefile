...
SOURCES_SERVER = Src/Rendezvous.cpp
LINKER_OPTIONS = -lboost_program_options
...
Client.o: ${SOURCES_CLIENT}
	${CC} ${CFLAGS} -I Include/ ${SOURCES_CLIENT} -o Client.o ${LINKER_OPTIONS}

Server.o: ${SOURCES_SERVER}
	${CC} ${CFLAGS} -I Include/ ${SOURCES_SERVER} -o Server.o ${LINKER_OPTIONS}